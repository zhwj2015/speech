...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Keymodels',
            fields=[
                ('model_id', models.CharField(max_length=20, serialize=False, primary_key=True)),
                ('name', models.CharField(max_length=250)),
        ...
        migrations.CreateModel(
            name='Keywords',
            fields=[
                ('word_id', models.CharField(max_length=20, serialize=False, primary_key=True)),
                ('keyword', models.CharField(max_length=250)),
                ('plus', models.BooleanField()),
                ('model_id', models.ForeignKey(to='quickstart.Keymodels')),
            ],
        ),
        migrations.CreateModel(
            name='Positions',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(to='quickstart.Positions')),
            ],
        ),
        migrations.CreateModel(
            name='Wavs',
        ...
        migrations.AddField(
            ...
            name='user_id',
            field=models.ForeignKey(to='quickstart.Users'),
        ),
        migrations.AddField(
            model_name='relations',
            name='wav_id',
            field=models.ForeignKey(to='quickstart.Wavs'),
        ),
        migrations.AddField(
            model_name='relations',
            name='word_id',
